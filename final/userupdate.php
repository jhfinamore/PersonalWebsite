...
if(isset($_POST['submit'])) {
    ...
    {
        try {
            $sqlusers = "SELECT * FROM finaluser_jhfinamor WHERE uname = :uname";
    ...
    {
        try {
            $sqlemails = "SELECT * FROM finaluser_jhfinamor WHERE email = :email";
    ...
    else
    {
        try
        {
            ...
            $sql = "UPDATE finaluser_jhfinamor SET fname = :fname,mi = :mi, lname = :lname, uname = :uname, email = :email, password = :password, ethnicity = :ethnicity, dateofbirth = :dateofbirth, additionalInfo = :additionalinfo, url = :url, schoolyear = :schoolyear, inputdate = :inputdate WHERE ID = :ID";
...
if($formshow == 1) {
    if ($_SESSION['ID'] == $_GET['ID']) {
        ...
        $sql = "SELECT * FROM finaluser_jhfinamor WHERE ID = :ID";
        $stmt = $pdo->prepare($sql);
        ...
        <form id="updateform" method="post" action="change.php" name="updateform">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="mi" name="mi"
                               value="<?php if (isset($formfield['mi']) && !empty($formfield['mi'])) {
                                   echo $formfield['mi'];
                               } else {
                                   echo $row['mi'];
                               } ?>"/></td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" id="jhf-cauc" name="jhf"
                               value="c" <?php if (isset($formfield['jhf']) && $formfield['jhf'] == "c") {
                            echo "checked";
                        } else {
                            if ($row['ethnicity'] == "c") {
                                echo "checked";
                        ...
                        <input type="radio" id="jhf-afam" name="jhf"
                               value="a" <?php if (isset($formfield['jhf']) && $formfield['jhf'] == "a") {
                            echo "checked";
                        } else {
                            if ($row['ethnicity'] == "a") {
                                echo "checked";
                        ...
                        <input type="radio" id="jhf-asian" name="jhf"
                               value="s" <?php if (isset($formfield['jhf']) && $formfield['jhf'] == "s") {
                            echo "checked";
                        } else {
                            if ($row['ethnicity'] == "s") {
                                echo "checked";
                        ...
                        <input type="radio" id="jhf-natam" name="jhf"
                               value="n" <?php if (isset($formfield['jhf']) && $formfield['jhf'] == "n") {
                            echo "checked";
                        } else {
                            if ($row['ethnicity'] == "n") {
                                echo "checked";
                        ...
                        <span class="error">* <?php if (isset($errorethnicity)) {
                                echo $errorethnicity;
                            } ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" id="dob" name="dob" size="20"
                               value="<?php if (isset($formfield['dateOfBirth']) && !empty($formfield['dateOfBirth'])) {
                                   echo $formfield['dateOfBirth'];
                               } else {
                                   echo $row['dateofbirth'];
                               } ?>">
                        <span class="error">* <?php if (isset($errordob)) {
                                echo $errordob;
                            } ?></span></td>
                </tr>
                <tr>
                    <th><label class="main" for="addinfo">Please enter any additional information about yourself</label>
                    </th>
                    <td><textarea id="addinfo"
                                  name="addinfo"><?php if (isset($formfield['addinfo']) && !empty($formfield['addinfo'])) {
                                echo $formfield['addinfo'];
                            } else {
                                echo $row['addinfo'];
                            } ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <select id="school" name="school">
                            <option value="" <?php if (isset($formfield['school']) && !empty($formfield['school'])) {
                                if ($formfield['school'] == "") {
                                    echo "selected";
                                }
                            } ?>>Please choose one
                            </option>
                            <option value="f" <?php if (isset($formfield['school']) && !empty($formfield['school'])) {
                                if ($formfield['school'] == "f") {
                                    echo "selected";
                                }
                            } else {
                                if ($row['schoolyear'] == "f") echo "selected";
                            } ?>>Freshman
                            </option>
                            <option value="s" <?php if (isset($formfield['school']) && !empty($formfield['school'])) {
                                if ($formfield['school'] == "s") {
                                    echo "selected";
                                }
                            } else {
                                if ($row['schoolyear'] == "s") echo "selected";
                            } ?>>Sophomore
                            </option>
                            <option value="j" <?php if (isset($formfield['school']) && !empty($formfield['school'])) {
                                if ($formfield['school'] == "j") {
                                    echo "selected";
                                }
                            } else {
                                if ($row['schoolyear'] == "j") echo "selected";
                            } ?>>Junior
                            </option>
                            <option value="m" <?php if (isset($formfield['school']) && !empty($formfield['school'])) {
                                if ($formfield['school'] == "m") {
                                    echo "selected";
                                }
                            } else {
                                if ($row['schoolyear'] == "m") echo "selected";
                            } ?>>Senior
                            </option>
                        </select><span class="error">* <?php if (isset($errorschoolyr)) {
                                echo $errorschoolyr;
                            } ?></span>
                    </td>
                </tr>
