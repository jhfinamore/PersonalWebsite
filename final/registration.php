...
$inputdate = time();
$_formshow = 1;
$_pageTitle= "Registration Page";
$errormsg = 0;
$errorfname = $errorlname =  $erroruname = $errorethnicity = $errordob = $erroraddinfo = $erroremail = $errorpassword = $errorconfpassword = $errorpwdmatch =  $errorschoolyr = "";
require_once "_header.php";

if(isset($_SESSION['ID']))
{
    echo "<p>You are already logged in so please log out before creating a new account.</p>";
...
if(isset($_POST['submit']))
{
    ...
    else
    {
        try
        {
            ...
            $sql = "INSERT INTO finaluser_jhfinamor (fname, mi, lname, uname, email, password, ethnicity, dateofbirth, addinfo, schoolyear, inputdate)
                    VALUES (:fname, :mi, :lname, :uname, :email, :password, :ethnicity, :dateofbirth, :addinfo, :school, :inputdate)";
            ...
            //print confirmation
            echo "<p class='success'>SUCCESS!  Thank you for registering to be a user!</p>";
            $_formshow = 0;
        }
        catch (PDOException $e)
        {
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="password" id="confpassword" name="confpassword" size="20" value="<?php if(isset($formfield['confpassword'])) {echo $formfield['confpassword'];} ?>"/>
                        <span class="error">* <?php if(isset($errorconfpassword)) {echo $errorconfpassword;} if(isset($errorpwdmatch)){echo $errorpwdmatch;} ?></span></td>
                </tr>
                <tr>
