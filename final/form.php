...
*/
    ...
    $errormsg = 0;
    $test = "This is for the sake of trying things.";
...
if(isset($_POST['submit']))
    ...
    if($_formshow == 1) {
        ...
        <form method="post" action="form.php" name="myform" id="myform" onsubmit="validate();">
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="firstname" name="firstname" size="10" value="<?php if(isset($formfield['fname'])) {echo $formfield['fname'];}?>" />
                            <span class="error">* <?php if(isset($errorfname)) {echo $errorfname;} ?></span>
                            <div id="ferror"></div></td>
                    </tr>
                    <tr>
